...
| `rpm33` | 1800ms linear ∞ | vinyl spin — with **spin-up** (ease-in from rest on play) and **coast-to-stop** (ease-out on pause); an asymmetric label makes the turn legible even on artwork-less tracks |
